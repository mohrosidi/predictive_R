...
Terdapat beberapa paket yang digunakan dalam pembuatan model prediktif menggunakan *k-nearest neighbors*. Paket-paket yang digunakan ditampilkan sebagai berikut:
...
Berdasarkan hasil yang diperoleh, nilai **RMSE** rata-rata model sebesar `r knn_rmse`.
