...
![](naive-bayes-classification_files/figure-gfm/target-vis-2.png)<!-- -->
...
![](naive-bayes-classification_files/figure-gfm/hist-1.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/hist-2.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/hist-3.png)<!-- -->
...
![](naive-bayes-classification_files/figure-gfm/nb-cv-vis-1.png)<!-- -->
...
![](naive-bayes-classification_files/figure-gfm/nb-vis-1.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-2.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-3.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-4.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-5.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-6.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-7.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-8.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-9.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-10.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-11.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-12.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-13.png)<!-- -->![](naive-bayes-classification_files/figure-gfm/nb-vis-14.png)<!-- -->
