...
Terdapat beberapa paket yang digunakan dalam pembuatan model prediktif menggunakan *Principle Component Regression* (PCR). Paket-paket yang digunakan ditampilkan sebagai berikut:
