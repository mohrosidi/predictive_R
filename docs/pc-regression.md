...
menggunakan *Principle Component Regression* (PCR). Paket-paket yang
...
2.  `pls` : berisikan fungsi untuk membentuk model PCR dan PLS
...
![](pc-regression_files/figure-gfm/target-vis-1.png)<!-- -->
...
![](pc-regression_files/figure-gfm/target-vis-2.png)<!-- -->
...
![](pc-regression_files/figure-gfm/missing-vis-1.png)<!-- -->
...
![](pc-regression_files/figure-gfm/hist-1.png)<!-- -->![](pc-regression_files/figure-gfm/hist-2.png)<!-- -->![](pc-regression_files/figure-gfm/hist-3.png)<!-- -->![](pc-regression_files/figure-gfm/hist-4.png)<!-- -->![](pc-regression_files/figure-gfm/hist-5.png)<!-- -->![](pc-regression_files/figure-gfm/hist-6.png)<!-- -->![](pc-regression_files/figure-gfm/hist-7.png)<!-- -->![](pc-regression_files/figure-gfm/hist-8.png)<!-- -->![](pc-regression_files/figure-gfm/hist-9.png)<!-- -->

``` r
plot_bar(data_train, ncol = 2L, nrow = 2L)
```

![](pc-regression_files/figure-gfm/bar-1.png)<!-- -->![](pc-regression_files/figure-gfm/bar-2.png)<!-- -->![](pc-regression_files/figure-gfm/bar-3.png)<!-- -->![](pc-regression_files/figure-gfm/bar-4.png)<!-- -->![](pc-regression_files/figure-gfm/bar-5.png)<!-- -->![](pc-regression_files/figure-gfm/bar-6.png)<!-- -->![](pc-regression_files/figure-gfm/bar-7.png)<!-- -->![](pc-regression_files/figure-gfm/bar-8.png)<!-- -->![](pc-regression_files/figure-gfm/bar-9.png)<!-- -->![](pc-regression_files/figure-gfm/bar-10.png)<!-- -->
...
![](pc-regression_files/figure-gfm/heatmap-1.png)<!-- -->

``` r
plot_boxplot(data_train, by = "Sale_Price", ncol = 2, nrow = 1)
```

![](pc-regression_files/figure-gfm/boxplot-1.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-2.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-3.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-4.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-5.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-6.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-7.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-8.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-9.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-10.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-11.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-12.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-13.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-14.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-15.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-16.png)<!-- -->![](pc-regression_files/figure-gfm/boxplot-17.png)<!-- -->
...
blueprint <- recipe(Sale_Price ~., data = data_train) %>%
  ...
  step_corr(all_numeric(), -all_outcomes(), threshold = 0.5, method = "spearman") %>%
  # label encoding
...
```
    ...
    ## Correlation filter removed First_Flr_SF, Gr_Liv_Area, ... [trained]
...
```
    ...
    ## # ... with 2,043 more rows, and 47 more variables: Condition_1 <fct>,
    ...
    ## #   Central_Air <fct>, Electrical <fct>, Bsmt_Full_Bath <dbl>,
    ## #   Bsmt_Half_Bath <dbl>, Half_Bath <dbl>, Bedroom_AbvGr <dbl>,
    ## #   Kitchen_AbvGr <dbl>, Fireplaces <dbl>, Garage_Type <fct>,
    ## #   Garage_Finish <fct>, Garage_Area <dbl>, Garage_Cond <fct>,
    ...
    ## #   Year_Sold <dbl>, Sale_Type <fct>, Sale_Condition <fct>, Longitude <dbl>,
...
```
    ...
    ##   73 predictor
    ## 
    ## Recipe steps: nzv, corr, other, center, scale 
    ## Resampling: Cross-Validated (10 fold) 
    ## Summary of sample sizes: 1847, 1847, 1849, 1847, 1847, 1849, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   ncomp  RMSE      Rsquared   MAE     
    ##   1      43831.13  0.7003854  31443.57
    ##   2      43706.17  0.7020866  31274.37
    ##   3      41770.20  0.7285976  29475.43
    ## 
...
![](pc-regression_files/figure-gfm/pc-cv-vis-1.png)<!-- -->
...
![](pc-regression_files/figure-gfm/pc-res-vis-1.png)<!-- -->
...
![](pc-regression_files/figure-gfm/pc-vip-1.png)<!-- -->
...
Garage\_Area, Year\_Remod\_Add, Latitude. Untuk melihat efek
...
![](pc-regression_files/figure-gfm/pc-pdp-1.png)<!-- -->
