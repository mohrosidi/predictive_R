...
menggunakan *regularized regression*. Paket-paket yang digunakan
...
![](regularized-regression_files/figure-gfm/target-vis-1.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/target-vis-2.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/missing-vis-1.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/hist-1.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-2.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-3.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-4.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-5.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-6.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-7.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-8.png)<!-- -->![](regularized-regression_files/figure-gfm/hist-9.png)<!-- -->

``` r
plot_bar(data_train, ncol = 2L, nrow = 2L)
```

![](regularized-regression_files/figure-gfm/bar-1.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-2.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-3.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-4.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-5.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-6.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-7.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-8.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-9.png)<!-- -->![](regularized-regression_files/figure-gfm/bar-10.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/heatmap-1.png)<!-- -->

``` r
plot_boxplot(data_train, by = "Sale_Price", ncol = 2, nrow = 1)
```

![](regularized-regression_files/figure-gfm/boxplot-1.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-2.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-3.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-4.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-5.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-6.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-7.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-8.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-9.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-10.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-11.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-12.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-13.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-14.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-15.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-16.png)<!-- -->![](regularized-regression_files/figure-gfm/boxplot-17.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/rr-cv-vis-1.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/rr-res-vis-1.png)<!-- -->
...
![](regularized-regression_files/figure-gfm/rr-vip-1.png)<!-- -->
